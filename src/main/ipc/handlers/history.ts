...
export function registerHistoryHandlers(): void {
  ...
  ipcMain.handle('history:clear', async (_event, projectPath?: string, sessionId?: string) => {
    if (sessionId) {
  ...
  ipcMain.handle('history:delete', async (_event, entryId: string, sessionId?: string) => {
    if (sessionId) {
  ...
  // If sessionId is provided, search only that session; otherwise search all sessions
  ipcMain.handle('history:update', async (_event, entryId: string, updates: Partial<HistoryEntry>, sessionId?: string) => {
    if (sessionId) {
  ...
  ipcMain.handle('history:listSessions', async () => {
