...
import { NodeBreadcrumb, type NodeBreadcrumbProps } from '../../../../renderer/components/DocumentGraph/NodeBreadcrumb';
import type { Theme } from '../../../../renderer/types';
import type { DocumentNodeData, ExternalLinkNodeData } from '../../../../renderer/components/DocumentGraph/graphDataBuilder';
...
function createExternalNodeData(domain: string, urls: string[] = []): ExternalLinkNodeData & { theme: Theme } {
  return {
    nodeType: 'external',
    domain,
...
describe('NodeBreadcrumb', () => {
  ...
  describe('Theme styling', () => {
    ...
    it('applies light theme colors correctly', () => {
      ...
      const { container } = render(
        <NodeBreadcrumb
          selectedNodeData={lightNodeData}
          theme={lightTheme}
          rootPath="/project"
        />
      );
