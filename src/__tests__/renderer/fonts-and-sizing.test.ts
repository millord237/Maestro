...
describe('Cross-platform Fonts and Sizing', () => {
  ...
  describe('Default Font Stack', () => {
    ...
    it('should have matching CSS base font stack in index.css', () => {
      ...
      expect(cssBaseFonts.every(font =>
        font.includes('Mono') || font.includes('Code') || font.includes('Courier') || font === 'monospace'
      )).toBe(true);
    });
  });
  ...
  describe('Common Monospace Fonts Panel', () => {
    ...
    it('should include cross-platform fonts', () => {
      const crossPlatformFonts = ['Roboto Mono', 'JetBrains Mono', 'Fira Code', 'Source Code Pro', 'Courier New'];
