...
export function TransferErrorModal({
  ...
  const installInstructions = error.details?.installInstructions ||
  ...
  return (
    ...
    >
      ...
      {(error.sourceAgent || error.targetAgent) && (
        <div className="flex items-center justify-center gap-2 mb-4 pb-4 border-b" style={{ borderColor: theme.colors.border }}>
          {error.sourceAgent && (
            <span
