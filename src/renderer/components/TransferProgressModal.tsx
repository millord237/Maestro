...
import { X, Check, Loader2, AlertTriangle, ArrowRight } from 'lucide-react';
    ...
    >
      ...
      >
        ...
        <p className="text-xs mb-4" style={{ color: theme.colors.textDim }}>
          This will abort the transfer operation and clean up any temporary resources.
        ...
        <div className="p-6">
          ...
          <div className="text-center mb-6">
            <p
              ...
              style={{ color: theme.colors.textMain }}
            >
              {progress.message || TRANSFER_STAGES[currentStageIndex]?.getActiveLabel(targetAgentName) || 'Processing...'}
            </p>
            {!isComplete && (
