...
export interface GroupChatContextValue {
  ...
  setAllGroupChatParticipantStates: React.Dispatch<React.SetStateAction<Map<string, Map<string, 'idle' | 'working'>>>>;

  // Moderator usage stats
  moderatorUsage: { contextUsage: number; totalCost: number; tokenCount: number } | null;
  setModeratorUsage: React.Dispatch<React.SetStateAction<{ contextUsage: number; totalCost: number; tokenCount: number } | null>>;
...
export function GroupChatProvider({ children }: GroupChatProviderProps) {
  ...
  const value = useMemo<GroupChatContextValue>(() => ({
    ...
    groupChatMessages,
    // State
    groupChatState, groupChatStates,
    // Participant states
    participantStates, allGroupChatParticipantStates,
    // Moderator usage
    moderatorUsage,
    // Staged images
    groupChatStagedImages,
    ...
    groupChatError,
    // Convenience methods
    clearGroupChatError, resetGroupChatState,
  ]);
