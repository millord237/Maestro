...
export const TAB_SHORTCUTS: Record<string, Shortcut> = {
  ...
  closeTabsLeft: { id: 'closeTabsLeft', label: 'Close Tabs to Left', keys: ['Meta', 'Shift', 'Alt', '['] },
  closeTabsRight: { id: 'closeTabsRight', label: 'Close Tabs to Right', keys: ['Meta', 'Shift', 'Alt', ']'] },
